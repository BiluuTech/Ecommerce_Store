...
public class ElectronicsSubcategoryActivity extends AppCompatActivity {

    private RecyclerView electronicsSubcatRecyclerview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electronics_subcategory);
        toolbar = findViewById(R.id.electronicSubcatToolbar);
        ...
        electronicsSubcatRecyclerview = findViewById(R.id.electronics_subcat_recyclerview);
        electronicsSubcatRecyclerview.setHasFixedSize(true);
        electronicsSubcatRecyclerview.setLayoutManager(new LinearLayoutManager(this));

        subcategoryModelList = new ArrayList<>();

        searchEditText = findViewById(R.id.search_electronics_edittext);
        ...
        electronicsRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    userSubcategoryAdapter = new UserSubcategoryAdapter(ElectronicsSubcategoryActivity.this,subcategoryModelList);
                    electronicsSubcatRecyclerview.setAdapter(userSubcategoryAdapter);
