...
public class MenSubcategoryActivity extends AppCompatActivity {

    private RecyclerView menSubcatRecyclerview;
    private UserSubcategoryAdapter userSubcategoryAdapter;
    private List<SubcategoryModel> subcategoryModelList;

    private DatabaseReference menRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_men_subcategory);

        toolbar = findViewById(R.id.menSubcatToolbar);
        ...
        menRef = FirebaseDatabase.getInstance().getReference().child("men");

        menSubcatRecyclerview = findViewById(R.id.men_subcat_recyclerview);
        menSubcatRecyclerview.setHasFixedSize(true);
        menSubcatRecyclerview.setLayoutManager(new LinearLayoutManager(this));

        subcategoryModelList = new ArrayList<>();

        searchEditText = findViewById(R.id.search_mens_edittext);
        ...
        menRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    userSubcategoryAdapter = new UserSubcategoryAdapter(MenSubcategoryActivity.this,subcategoryModelList);
                    menSubcatRecyclerview.setAdapter(userSubcategoryAdapter);
