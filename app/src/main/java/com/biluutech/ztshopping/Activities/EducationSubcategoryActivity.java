...
public class EducationSubcategoryActivity extends AppCompatActivity {

    private RecyclerView grocerySubcatRecyclerview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_education_subcategory);

        toolbar = findViewById(R.id.grocerySubcatToolbar);

        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        groceryRef = FirebaseDatabase.getInstance().getReference().child("education");

        grocerySubcatRecyclerview = findViewById(R.id.grocery_subcat_recyclerview);
        grocerySubcatRecyclerview.setHasFixedSize(true);
        grocerySubcatRecyclerview.setLayoutManager(new LinearLayoutManager(this));

        subcategoryModelList = new ArrayList<>();

        searchEditText = findViewById(R.id.search_education_edittext);
        ...
        groceryRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    userSubcategoryAdapter = new UserSubcategoryAdapter(EducationSubcategoryActivity.this, subcategoryModelList);
                    grocerySubcatRecyclerview.setAdapter(userSubcategoryAdapter);
